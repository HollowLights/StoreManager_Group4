...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public List<OrderDetail> getChiTietByOrderId(int orderId) {
        ...
        if (cursor != null && cursor.moveToFirst()) {
            do {
                ...
                if (idChitietIndex != -1 && idDathangIndex != -1 && maspIndex != -1 &&
                    ...
                    OrderDetail chiTiet = new OrderDetail(idChitiet, idDathang, masp, soluong, dongia, anh);
                    chiTietList.add(chiTiet);
    ...
    public List<Product> getProductsByNhomSpId(String nhomSpId) {
        ...
        if (cursor.moveToFirst()) {
            do {
                ...
                Product product = new Product(masp, tensp, dongia, mota, ghichu, soluongkho, mansp, anh);
    ...
    public ArrayList<Product> searchSanPhamByName(String name) {
        ...
        if (cursor.moveToFirst()) {
            do {
                ...
                if (maspIndex != -1 && tenspIndex != -1) {
                    ...
                    Product product = new Product(masp, tensp, dongia, mota, ghichu, soluongkho, manhomsanpham, anh);
                    productList.add(product);
                }
            } while (cursor.moveToNext());
        }
