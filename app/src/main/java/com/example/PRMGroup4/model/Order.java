...
public class Order {
    ...
    private List<OrderDetail> chiTietList; // Danh sách chi tiết đơn hàng
    ...
    public List<OrderDetail> getChiTietList() {
        return chiTietList; // Getter cho danh sách chi tiết
    }

    public void setChiTietList(List<OrderDetail> chiTietList) {
