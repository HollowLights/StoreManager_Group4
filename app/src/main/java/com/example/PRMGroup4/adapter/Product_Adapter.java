...
public  class Product_Adapter extends BaseAdapter {
    ...
    public Product_Adapter(Context context, ArrayList<Product> bacsiList, boolean showFullDetails) {
    ...
    private void showEditDialog(Product tt) {
    ...
    private void updateSanPham(Product tt, EditText editMasp, EditText editTensp, EditText editDongia, EditText editMota, EditText editGhichu, EditText editSoluongkho, Spinner editMansp) {
        ...
        // Lấy maso từ spinner
        String newMansp = ((Category) editMansp.getSelectedItem()).getMa(); // Lấy maso thay vì tennhom
    ...
    private ArrayList<Category> mangNSPList;
    ...
    private void loadTenNhomSanPham(Spinner mansp) {
        ...
        while (cursor.moveToNext()) {
            ...
            mangNSPList.add(new Category(maso,tennhom,null)); // Thêm vào danh sách
        }

        // Tạo adapter cho Spinner
        ArrayAdapter<Category> adapter = new ArrayAdapter<>(context, android.R.layout.simple_spinner_item, mangNSPList);
