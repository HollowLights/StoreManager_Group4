...
public class AddProduct_Activity extends AppCompatActivity {
    ...
    ArrayList<Category> mangNSPList;
    ...
    private void loadTenNhomSanPham() {
        ...
        while (cursor.moveToNext()) {
            ...
            mangNSPList.add(new Category(maso, tennhom, null)); // null nếu không cần ảnh
        }

        // Tạo adapter cho Spinner
        ArrayAdapter<Category> adapter = new ArrayAdapter<>(this, android.R.layout.simple_spinner_item, mangNSPList);
    ...
    private void addSanPham() {
        ...
        if (tenNsp.isEmpty() || motaStr.isEmpty() || ghichuStr.isEmpty() || dongiaStr.isEmpty() || soluongStr.isEmpty()) {
            Toast.makeText(AddProduct_Activity.this, "Vui lòng điền đầy đủ thông tin!", Toast.LENGTH_SHORT).show();
            return;
        }
        ...
        if (imageUri != null) {
            ...
            if (imageBytes == null) {
                Toast.makeText(AddProduct_Activity.this, "Lỗi khi lấy ảnh!", Toast.LENGTH_SHORT).show();
                return;
            }
        }
        ...
        try {
            ...
            Toast.makeText(AddProduct_Activity.this, "Giá trị không hợp lệ!", Toast.LENGTH_SHORT).show();
            return;
        }
        ...
        Toast.makeText(AddProduct_Activity.this, "Thêm sản phẩm thành công!", Toast.LENGTH_LONG).show();

        // Chuyển đến Activity thứ hai
        Intent intent = new Intent(getApplicationContext(), ProductAdmin_Activity.class);
    ...
    private void openDrawableImagePicker() {
        final String[] imageNames = {"banhga1","banhga2","banhkem1", "banhkem2","banhngot1","banhnho1", "banhnho2","bongngo1","bongngo2", "hamberger1","hamberger2","hamberger3", "pizza1","pizza2","pizza3","sandwich1","sandwich2", "sandwich3", "taco1","taco2"};
