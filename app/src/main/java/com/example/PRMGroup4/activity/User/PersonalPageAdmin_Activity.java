...
public class PersonalPageAdmin_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (tendn != null) {
            ...
            Intent intent = new Intent(PersonalPageAdmin_Activity.this, Login_Activity.class);
        ...
        btntrangchu.setOnClickListener(view -> {
            ...
            Intent intent = new Intent(getApplicationContext(), HomePageAdmin_Activity.class);
            startActivity(intent);
        });

        dangxuat.setOnClickListener(v -> {
            new AlertDialog.Builder(PersonalPageAdmin_Activity.this)
                    .setTitle("Đăng Xuất")
