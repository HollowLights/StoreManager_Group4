    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ql.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent a=new Intent(ChangePassword_Activity.this, Login_Activity.class);
                startActivity(a);
            }
        });
        ...
        btndoimk.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (username.isEmpty() || password.isEmpty() || nhaplaimk.isEmpty()) {
                    Toast.makeText(ChangePassword_Activity.this, "Tên đăng nhập và mật khẩu không được để trống!", Toast.LENGTH_SHORT).show();
                    return;
                }

                // Kiểm tra xem mật khẩu và mật khẩu xác nhận có trùng nhau không
                if (!password.equals(nhaplaimk)) {
                    Toast.makeText(ChangePassword_Activity.this, "Mật khẩu không khớp, vui lòng kiểm tra lại!", Toast.LENGTH_SHORT).show();
                    return;
                }
                ...
                if (cursor.getCount() <= 0) {
                    Toast.makeText(ChangePassword_Activity.this, "Tên đăng nhập không tồn tại, vui lòng nhập tên khác!", Toast.LENGTH_SHORT).show();
                    return;
                }
                ...
                Toast.makeText(ChangePassword_Activity.this, "Đổi mật khẩu thành công", Toast.LENGTH_LONG).show();
