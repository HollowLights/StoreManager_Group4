  ...
  Category_Adapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
      ...
      tennsp= findViewById(R.id.ten);
        ...
        adapter = new Category_Adapter(AddCategory_Activity.this, mangNSP, true) {
        };
        ...
        btnthem.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (tenNsp.isEmpty() ) {
                    Toast.makeText(AddCategory_Activity.this, "Vui lòng điền đầy đủ thông tin!", Toast.LENGTH_SHORT).show();
                    return;
                }
                ...
                if (imageUri != null) {
                    ...
                    if (imageBytes == null) {
                        Toast.makeText(AddCategory_Activity.this, "Lỗi khi lấy ảnh!", Toast.LENGTH_SHORT).show();
                        return;
                    }
                }
                ...
                Intent intent = new Intent(getApplicationContext(), CategoryAdmin_Actvity.class);
