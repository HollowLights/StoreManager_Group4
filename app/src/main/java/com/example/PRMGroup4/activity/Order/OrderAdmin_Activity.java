...
import com.example.PRMGroup4.adapter.Order_Adapter;
import com.example.PRMGroup4.database.Database;
import com.example.PRMGroup4.model.Order;

import java.util.List;

public class OrderAdmin_Activity extends AppCompatActivity {

    private Database database;
    private ListView listView;
    private Order_Adapter donHangAdapter;
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (order != null) {
                    ...
                    Toast.makeText(OrderAdmin_Activity.this, "ID đơn hàng: " + order.getId(), Toast.LENGTH_SHORT).show();

                    // Gửi thông tin đơn hàng qua Intent
                    Intent intent = new Intent(OrderAdmin_Activity.this, OrderDetailAdmin_Activity.class);
    ...
    private void loadDonHang() {
        ...
        if (orders.isEmpty()) {
            ...
            donHangAdapter = new Order_Adapter(this, orders);
