        ...
        btnLogin.setOnClickListener(v -> {
            ...
            if (validateLogin(username, password)) {
                ...
                if (quyen.equals("admin")) {
                    intent = new Intent(Login_Activity.this, HomePageAdmin_Activity.class);
                    Toast.makeText(this, "Đăng nhập với quyền Admin", Toast.LENGTH_SHORT).show();
                } else if (quyen.equals("user")) {
                    intent = new Intent(Login_Activity.this, HomePageUser_Activity.class);
    ...
    private void startAutoLogoutTimer() {
        ...
        timeoutRunnable = new Runnable() {
            ...
            public void run() {
                ...
                Intent intent = new Intent(Login_Activity.this, HomePageUser_Activity.class);
