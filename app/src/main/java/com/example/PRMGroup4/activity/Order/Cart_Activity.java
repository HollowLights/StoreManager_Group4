...
import com.example.PRMGroup4.adapter.Cart_Adapter;
...
import com.example.PRMGroup4.database.OrderManager;
...
public class Cart_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        List<Cart> cartList = cartManager.getGioHangList();
        adapter = new Cart_Adapter(this, cartList, txtTongTien);
        listView.setAdapter(adapter);

        // Cập nhật tổng tiền ngay từ giỏ hàng
        txtTongTien.setText(String.valueOf(cartManager.getTongTien()));
            ...
            if (tenKh.isEmpty() || diaChi.isEmpty() || sdt.isEmpty()) {
                ...
                if (orderManager != null) {
                    ...
                    if (orderId > 0) {
                        ...
                        cartManager.clearGioHang(); // Xóa giỏ hàng
                        txtTongTien.setText("0"); // Đặt tổng tiền về 0

                        adapter.notifyDataSetChanged(); // Cập nhật lại giao diện
                        Intent a = new Intent(Cart_Activity.this, HomePageUser_Activity.class);
                        startActivity(a);
                    } else {
